...
module NoC(input wire[0:0] CLK, input wire[0:0] RST_N, input wire[13:0] r1_in, r2_in, r3_in,  output wire[13:0] r1_ot, r2_ot, r3_ot, input wire[13:0] tile_in_out, output wire[0:0] tile_in_arg);
assign r1_in = 14'b0;
assign r2_in = 14'b0;
assign r3_in = 14'b0;
	reg[13:0] r1 /* verilator public */ = r1_in;
	reg[13:0] r2 /* verilator public */ = r1_in;
	reg[13:0] r3 /* verilator public */ = r1_in;
	...
	wire[13:0] _var_m01 = r1 ^ tile_in_out;
	...
	wire[13:0] _var_m02 = r2 ^ tile_in_out;
	...
	assign tile_in_arg = 1'b0;
	wire[13:0] _var_m03 = r3 ^ tile_in_out;
