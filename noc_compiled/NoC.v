...
module NoC(input wire[0:0] CLK, input wire[0:0] RST_N);
	...
	always @(posedge CLK) begin
		if (!RST_N) begin
			...
			r1 <= ((_cond0 ? _cond1 || ~($unsigned(_0) < $unsigned(2'b0)) : 1'b1) && (~_router_2_out0 && (~(_cond0 && _cond1) || ~_router_2_out0))) && (_cond0 && _cond1) ? {{r1[13 +: 1], 4'b0}, r1[0 +: 9]} : (_wF_router_20 ? (_cond2 && ~(_cond3 || ~_cond4) ? {{r2[13 +: 1], 4'b0001}, r2[0 +: 9]} : (_cond5 ? (_cond6 || ~_cond7 ? {1'b0, r1[0 +: 13]} : {{r1[13 +: 1], 4'b0001}, r1[0 +: 9]}) : r1)) : r1);
