...
Definition r0_send: UInternalFunction reg_t empty_ext_fn_t :=
  {{ fun r0_send (value: bits_t sz) : unit_t =>
    write0(r0, value)
  }}.

Definition r1_send: UInternalFunction reg_t empty_ext_fn_t :=
  {{ fun r1_send (value: bits_t sz) : unit_t =>
    write0(r1, value)
  }}.

Definition r2_send: UInternalFunction reg_t empty_ext_fn_t :=
  {{ fun r2_send (value: bits_t sz) : unit_t =>
    write0(r2, value)
  }}.

Definition r0_receive: UInternalFunction reg_t empty_ext_fn_t :=
  {{ fun r0_receive () : bits_t sz =>
    read0(r0)
  }}.

Definition r1_receive: UInternalFunction reg_t empty_ext_fn_t :=
  {{ fun r1_receive () : bits_t sz =>
    read0(r1)
  }}.

Definition r2_receive: UInternalFunction reg_t empty_ext_fn_t :=
  {{ fun r2_receive () : bits_t sz =>
    read0(r2)
  }}.
...
Definition to_action rl :=
  match rl with
  | route0_r => _routestart_r Ob~0~0~0~0 r0_send r0_receive
  | route1_r => _routecenter_r Ob~0~0~0~1 r0_send r1_send r0_receive r1_receive
  | route2_r => _routecenter_r Ob~0~0~1~0 r1_send r2_send r1_receive r2_receive
  | route3_r => _routeend_r Ob~0~0~1~1 r2_send r2_receive
  end.
