...
Module Router (Regs:Registers)(MyTypes: Typesize).
Import Regs.
...
Definition _routestart_r (r_addr2: nat) (r0_send r0_receive rtile_send: UInternalFunction reg_t ext_fn_t)
...
{{
    ...
    (( if (src_p != r_addr && new_data) then 
        ...
        r0_send(pack(subst(msg, new, |1`d0|))) (* To stop the packet from being processed again*)
    else
    pass ))
    ))
}}.
...
Definition _routecenter_r (r_addr2: nat) (r0_send r1_send r0_receive r1_receive rtile_send: UInternalFunction reg_t ext_fn_t) 
(Tile_In Tile_Out : ext_fn_t)
: uaction reg_t ext_fn_t :=
  UBind "r_addr" (USugar (UConstBits (Bits.of_nat addr_sz r_addr2)))
  {{
...
Definition _routeend_r (r_addr2: nat) (r0_send r0_receive rtile_send: UInternalFunction reg_t ext_fn_t) 
(Tile_In Tile_Out : ext_fn_t)
: uaction reg_t ext_fn_t :=
  UBind "r_addr" (USugar (UConstBits (Bits.of_nat addr_sz r_addr2)))
  {{
