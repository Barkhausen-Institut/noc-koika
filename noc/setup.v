...
Module Setup
  ...
  (** Router state
      ...
      For the pipeline every router owns the upstream transfer.
   *)
  ...
  | router : Fin.t nocsize -> router_reg_t -> reg_t
  .
   ...
   *)
  Inductive ext_fn_t : Type :=
  | ext_fun : Fin.t nocsize -> ext_com_t -> ext_fn_t
  .
  ...
  | rule : Fin.t nocsize -> rule_name_t.
