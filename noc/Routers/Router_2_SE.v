...
Definition _routepr_r (r_addr2: bits_t 4) (southreceive eastreceive southsend eastsend: UInternalFunction reg_t empty_ext_fn_t) 
...
Definition to_action rl :=
    match rl with
    | route0_r => _routepr_r Ob~0~1~0~1 southreceive eastreceive southsend eastsend
    end.
