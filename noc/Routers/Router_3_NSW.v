...
Definition _routepr_r (r_addr2: bits_t 4) (northreceive southreceive westreceive northsend southsend westsend: UInternalFunction reg_t empty_ext_fn_t) 
...
Definition to_action rl :=
    match rl with
    | route0_r => _routepr_r Ob~0~1~0~1 northreceive southreceive westreceive northsend southsend westsend
    end.
